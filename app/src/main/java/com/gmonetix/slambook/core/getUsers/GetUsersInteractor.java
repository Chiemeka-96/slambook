package com.gmonetix.slambook.core.getUsers;
...
public class GetUsersInteractor implements GetUsersContract.Interactor {
    ...
    public void getAllUsersFromFirebase() {
        FirebaseDatabase.getInstance().getReference().child(Const.ARG_USERS).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
