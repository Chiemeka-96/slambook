...
public class ReadSlamActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(getApplicationContext(),getResources().getString(R.string.ad_received_slam_activity));
        adView = (AdView) findViewById(R.id.adViewReadSlams);
        AdRequest adRequest = new AdRequest.Builder().addTestDevice(Device.getId(ReadSlamActivity.this)).build();
        ...
        ReadSlamActivity.this.setTitle(name);
        ...
        StringRequest rqst = new StringRequest(Request.Method.POST, Const.read_slam,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("from_user_name",fromUserName);
                return params;
            }
        };
        RequestQueue queue = Volley.newRequestQueue(ReadSlamActivity.this);
        queue.add(rqst);
    ...
    private void init() {
        UtilsUI.getUilInstance(ReadSlamActivity.this);
        ...
        imageView = (ImageView) findViewById(R.id.read_slam_activity_profile_image);
        progressBarImage = (ProgressBar) findViewById(R.id.read_slam_activity_profile_image_progrss_bar);
    ...
    private void setHeader() {
        ...
        ReadSlamActivity.this.setTitle("Friend");
        ...
        UtilsUI.applyFontForToolbarTitle(ReadSlamActivity.this);
