...
public class FriendRequestAdapter extends RecyclerView.Adapter<FriendRequestAdapter.ViewHolder>{
    ...
    @NonNull
    private OnRequestAcceptedListeneer onRequestAcceptedListeneer;


    public FriendRequestAdapter(List<Friend> friendRequestList, Context context, @NonNull OnRequestAcceptedListeneer onRequestAcceptedListeneer) {
        this.appPref = App.getAppPref();
        this.friendRequestList = friendRequestList;
        this.context = context;
        this.onRequestAcceptedListeneer = onRequestAcceptedListeneer;
    }

    public interface OnRequestAcceptedListeneer {
        void onRequestAccepted(int pos);
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View AdapterView = LayoutInflater.from(parent.getContext()).inflate(R.layout.friend_cardview, parent, false);
        return new FriendRequestAdapter.ViewHolder(AdapterView, context);
    }

    @Override
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final Friend friend = friendRequestList.get(position);
            ...
            public void onClick(View v) {
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.url_accept_friend_request,
                            ...
                            public void onResponse(String s) {
                                try {
                                    ...
                                    if (object.getString("code").equals("success")) {
                                        ...
                                        onRequestAcceptedListeneer.onRequestAccepted(position);
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("friend_user_name",friend.getFriendUsername());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v, Context context) {
            ...
            acceptRequest = (Button) v.findViewById(R.id.friend_cardview_send_rqst);
            acceptRequest.setBackgroundResource(R.drawable.ic_friend_accept_request_black);
